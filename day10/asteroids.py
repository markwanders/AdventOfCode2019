...
def between(point1, point2, point3):
    return (point2[0] <= point3[0] <= point1[0] or point1[0] <= point3[0] <= point2[0]) and \
           (point2[1] <= point3[1] <= point1[1] or point1[1] <= point3[1] <= point2[1])
...
for asteroid1 in asteroids:
    for asteroid2 in (a for a in asteroids if a != asteroid1):
        if not any([asteroid3 for asteroid3 in asteroids if asteroid3 != asteroid1 and asteroid3 != asteroid2 if in_line_of_sight(asteroid1, asteroid2, asteroid3)]):
